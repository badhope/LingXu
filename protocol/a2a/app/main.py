...
from .agent import A2AData
from .agent_executor import DataExecutor
...
async def main(host: str = "localhost", port: int = 10000):
    ...
    try:
        ...
        agent_card = AgentCard(
            ...
            version="1.0.0",
            defaultInputModes=A2AData.SUPPORTED_CONTENT_TYPES,
            defaultOutputModes=A2AData.SUPPORTED_CONTENT_TYPES,
        ...
        request_handler = DefaultRequestHandler(
            agent_executor=DataExecutor(
                agent_factory=lambda: A2AData.create(max_steps=3)
            ),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Start Data Agent service")
    parser.add_argument(
        "--host",
        type=str,
        default="localhost",
