...
from app.prompt.data import NEXT_STEP_PROMPT, SYSTEM_PROMPT
...
class SandboxData(ToolCallAgent):
    """A versatile general-purpose agent with support for both local and MCP tools."""

    name: str = "SandboxData"
    ...
    def initialize_helper(self) -> "SandboxData":
        """Initialize basic components synchronously."""
        self.browser_context_helper = BrowserContextHelper(self)
        return self

    @classmethod
    async def create(cls, **kwargs) -> "SandboxData":
        """Factory method to create and properly initialize a Data instance."""
        instance = cls(**kwargs)
