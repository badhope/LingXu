...
create_sandbox = None
start_supervisord_session = None
try:
    from app.daytona.sandbox import create_sandbox, start_supervisord_session
except Exception:
    logger.debug("Sandbox functions not available")
...
if DAYTONA_AVAILABLE:
    try:
        ...
        logger.warning(f"Failed to initialize Daytona in tool_base: {e}")
