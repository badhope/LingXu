...
# Try to import Daytona, but fail gracefully
try:
    from daytona import (
    ...
    logger.warning("Daytona is not installed. Sandbox functionality will be disabled.")
...
if DAYTONA_AVAILABLE:
    ...
    try:
        ...
        if daytona_config.api_key:
            ...
            logger.warning("No Daytona API key found. Sandbox functionality will be disabled.")
        ...
        logger.warning(f"Failed to initialize Daytona: {e}. Sandbox functionality will be disabled.")
        daytona = None
