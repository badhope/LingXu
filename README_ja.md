...
また、UIUCとOpenManusの研究者が共同開発した[DataAgent-RL](https://github.com/DataAgent/DataAgent-RL)をご紹介できることを嬉しく思います。これは強化学習（RL）ベース（GRPOなど）のLLMエージェントチューニング手法に特化したオープンソースプロジェクトです。
