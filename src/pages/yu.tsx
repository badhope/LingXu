...
const module = MAIN_MODULES[4] // 空间

export default function YuPage() {
  const subModules = [
    { id: 'sanjie', name: '三界', desc: '欲界色界无色界', icon: '🌌' },
    { id: 'dongtian', name: '洞天', desc: '十大洞天，三十六小洞天', icon: '🏔️' },
    { id: 'weidu', name: '维度', desc: '多维空间探索', icon: '🔮' },
    { id: 'mijie', name: '秘界', desc: '隐秘空间，结界之地', icon: '✨' },
  ]
